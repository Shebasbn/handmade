...
set CommonCompilerFlags= -MTd -Gm- -GR- -EHa- -Od -Oi -FC -Z7 -nologo -W4 -WX -wd4201 -wd4100 -wd4189 -wd4505 -DHANDMADE_INTERNAL=1 -DHANDMADE_SLOW=1 -DHANDMADE_WIN32=1 -DUNICODE -D_UNICODE
